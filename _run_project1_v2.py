...
print("=" * 60)
print("PROJECT 1: Python Calculator Package")
print("=" * 60)
...
print(f"  AI calls (est):           3 (interpret+plan+generate_code)")
print(f"  Sandbox executions:       {len(ads_stages)} (ADS internal)")
print(f"  Test count:               {ads_out.get('test_out', {}).get('total_tests', '?')}")
